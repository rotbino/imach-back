// ─── تقسیمات کشوری ایران — تولید خودکار از lacal-data/Iran-provice.ts ──────
// منبع یگانه‌ی شهر→استان برای موتور تطبیق بک‌اند (عامل سورت استان).
// دستی ویرایش نشود؛ با scripts/gen-iran-geo.ts دوباره تولید شود.
// چند شهر هم‌نام بین دو استان وجود دارد (سردشت، نورآباد، …) — برای
// نقشه‌ی شهر→استان اولین وقوع نگه داشته می‌شود؛ تفکیک دقیق سطری کار فرانت است.

export const IRAN_CITY_PROVINCE: Record<string, string> = {
  ...
  "کیان": "چهارمحال و بختیاری",
  "ملک‌شهر": "چهارمحال و بختیاری",
  ...
  "قلعه‌رییسی": "کهگیلویه و بویراحمد",
  "گراب": "کهگیلویه و بویراحمد",
  ...
  "قلعه‌قهربان": "کهگیلویه و بویراحمد",
...
export const IRAN_PROVINCE_NAMES: string[] = [
  "آذربایجان شرقی",
  "آذربایجان غربی",
  "اردبیل",
  "اصفهان",
